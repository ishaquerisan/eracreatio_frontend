...
INSERT INTO blogs (slug, title, excerpt, content, image_url, category, author, published_at, is_published)
SELECT
  'top-vastu-tips-for-your-new-home',
...
WHERE NOT EXISTS (SELECT 1 FROM commercial_projects WHERE slug = 'era-business-hub');

INSERT INTO commercial_projects (slug, name, location, category, land_area, units, image_url, summary, details)
SELECT
  'era-commercial-centre',
  'Era Commercial Centre',
  'Kuttikattor, Calicut',
  'ongoing',
  '0.8 Acres',
...
WHERE NOT EXISTS (SELECT 1 FROM commercial_projects WHERE slug = 'era-commercial-centre');
...
SELECT
  ...
  '0.6 Acres',
  '24 Units',
  'https://images.unsplash.com/photo-1554435493-93422e8220c8?w=1600',
...
WHERE NOT EXISTS (SELECT 1 FROM commercial_projects WHERE slug = 'era-plaza');
